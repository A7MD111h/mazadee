...
<div class="container-fluid pt-4 px-4">
    <div class="bg-secondary text-center rounded p-4">
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            {{-- <a href="{{ route('admin_category_finsh')  }}" > </a> --}}
            ...
            <table class="table text-start align-middle table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  class="colorUsers">{{ $row->name }}</td>
                    
                        <td><a class="btn btn-square btn-outline-primary m-2" href="{{ route('admin_category_edit',$row->id ) }}"><i class="fa-regular fa-pen-to-square"></i></a></td>
                        <td style=" display: flex; gap:  1em;">
                            
                            <form method="POST" action="{{ route('admin_category_delete',$row->id) }}">
                                @csrf
                                @method('DELETE')
                            ...
                            <a href="{{ route('admin_category_finsh',$row->id)  }}" >
                                <button type="submit" onclick="return confirm('Record has been permanently deleted from the database, Are you sure?');" 
