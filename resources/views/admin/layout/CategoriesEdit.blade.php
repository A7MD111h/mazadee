        ...
        <div class="row g-4">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="bg-secondary rounded h-100 p-4">
                    ...
                    <form id="form" action="{{ route('admin_category_update',$categories_data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="name" required="" value="{{ $categories_data->name }}" class="form-control" id="inputEmail3">
